                ...
                <div style={{background:theme.cardBg,padding:'40px',borderRadius:'20px',border:`2px solid ${theme.border}`,boxShadow:darkMode?'0 8px 32px rgba(0,0,0,0.3)':'0 8px 32px rgba(0,0,0,0.1)'}}>
                  ...
                  <div style={{overflowX:'auto'}}>
                    <table style={{width:'100%',borderCollapse:'collapse'}}>
                      ...
                      <tbody>
                        {[{date:'27 Dec 2024',product:'Logitech Wireless Mouse M185',batch:'TWD-2024-1201',qty:50,supplier:'TechWorld Distributors'},{date:'26 Dec 2024',product:'Samsung USB Type-C Cable',batch:'EMI-2024-1156',qty:120,supplier:'ElectroMart India'},{date:'25 Dec 2024',product:'Cotton Round Neck T-Shirt',batch:'FG-2024-0889',qty:200,supplier:'Fashion Galaxy Pvt Ltd'},{date:'24 Dec 2024',product:'Nike Revolution 6 Running Shoes',batch:'SPW-2024-0456',qty:50,supplier:'SportWear Wholesale'}].map((item,i)=>(
                          <tr key={i} style={{borderBottom:`1px solid ${theme.border}`,cursor:'pointer'}} onMouseEnter={(e)=>e.currentTarget.style.background=theme.sidebarHover} onMouseLeave={(e)=>e.currentTarget.style.background='transparent'}>
