...
import { SafeCompanyProvider } from './context/SafeCompanyContext';
import { SafeWarehouseProvider } from './context/SafeWarehouseContext';
import Layout from './components/layout/Layout';
import './index.css';

console.log('✅ Starting Full Aura Inventory with Safe Contexts');
...
if (rootElement) {
  ...
  root.render(<App />);
  console.log('✅ Full app with safe contexts rendered');
} else {
